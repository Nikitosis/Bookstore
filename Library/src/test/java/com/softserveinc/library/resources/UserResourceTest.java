...
public class UserResourceTest {
    ...
    private BookService bookService=spy(new BookService(bookDao,configuration, requestSenderHttpService,requestSenderHttpService,awsStorageService,userService));
