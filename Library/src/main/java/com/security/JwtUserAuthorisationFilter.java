...
public class JwtUserAuthorisationFilter extends BasicAuthenticationFilter {

    private static final Logger log = LoggerFactory.getLogger(JwtUserAuthorisationFilter.class);

    private MainConfig mainConfig;

    public JwtUserAuthorisationFilter(AuthenticationManager authenticationManager, MainConfig mainConfig) {
